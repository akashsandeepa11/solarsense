      ...
      <form id="profile" action="<?php echo URLROOT ?>/installeradmin/update_profile/" method="post" novalidate>
        ...
        <div class="form-section mb-10">
          ...
          <div class="row">
            ...
            <div class="col-md-6 form-group">
              <?php $inputConfig = ['id' => 'contactNumber', 'name' => 'contactNumber', 'label' => 'Contact Number', 'type' => 'tel', 'icon' => 'fas fa-phone', 'value' => $profile_data['phone_number'] ?? '', 'required' => true];
              require APPROOT . '/views/inc/components/input_field.php'; ?>
            </div>
            <div class="col-md-6 form-group">
        ...
        <div class="form-section mb-10">
          ...
          <div class="row">
            <div class="col-md-6 form-group">
              <?php $inputConfig = ['id' => 'agent-id', 'name' => 'agent-id', 'label' => 'Agent ID', 'type' => 'text', 'icon' => 'fas fa-user', 'value' => $data['user_id'] ?? '', 'required' => true, 'editable'=>false];
              require APPROOT . '/views/inc/components/input_field.php'; ?>
            </div>
            <div class="col-md-6 form-group">
            ...
            <div class="col-md-6 form-group">
              <?php $inputConfig = ['id' => 'specialization', 'name' => 'specialization', 'label' => 'Specialization', 'type' => 'text', 'icon' => 'fas fa-envelope', 'value' => $profile_data['website'] ?? '', 'required' => true];
              require APPROOT . '/views/inc/components/input_field.php'; ?>
            </div>
          </div>
        </div>
