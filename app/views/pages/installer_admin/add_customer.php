...
<link rel="stylesheet" href="<?php echo URLROOT; ?>/public/css/pages/installer/add_customer.css">
    ...
    <div class="card shadow-lg rounded-xl">
        <div class="card-body p-10">
            ...
            <div class="form-header text-center mb-10">
                <h2 class="text-2xl font-bold">New Homeowner Registration</h2>
            ...
            <form id="registration-form" action="save.php" method="post" novalidate>
                ...
                <div id="step-2" class="form-step">
                    <div class="row">
                        <div class="col-md-6 form-group">
                            <?php $inputConfig = ['id' => 'systemCapacity', 'name' => 'systemCapacity', 'label' => 'System Capacity (kWp)', 'type' => 'number', 'icon' => 'fas fa-bolt', 'value' => $systemCapacity, 'required' => true]; require APPROOT . '/views/inc/components/input_field.php'; ?>
                        </div>
                        <div class="col-md-6 form-group">
                            <?php $inputConfig = ['id' => 'panelTilt', 'name' => 'panelTilt', 'label' => 'Panel Tilt (Degrees)', 'type' => 'number', 'icon' => 'fas fa-layer-group', 'value' => $panelTilt, 'required' => true]; require APPROOT . '/views/inc/components/input_field.php'; ?>
                        </div>
                        <div class="col-md-6 form-group mb-12">
                            <label for="panelAzimuth" class="form-label">Panel Azimuth (Orientation) <span class="text-error">*</span></label>
                        ...
                        <div class="col-md-6 form-group">
                            <?php $inputConfig = ['id' => 'installationDate', 'name' => 'installationDate', 'label' => 'Installation Date', 'type' => 'date', 'icon' => 'fas fa-calendar-alt', 'value' => $installationDate, 'required' => true]; require APPROOT . '/views/inc/components/input_field.php'; ?>
                        </div>
                        <div class="col-md-6 form-group">
                ...
                <div id="step-3" class="form-step">
                    <div style="max-width: 400px; margin: 2rem auto;">
                        <div class="form-group">
                            <?php $inputConfig = ['id' => 'cebAccount', 'name' => 'cebAccount', 'label' => 'CEB Account Number', 'type' => 'text', 'icon' => 'fas fa-file-invoice-dollar', 'value' => $cebAccount, 'required' => true]; require APPROOT . '/views/inc/components/input_field.php'; ?>
                        </div>
                        <div class="form-group">
