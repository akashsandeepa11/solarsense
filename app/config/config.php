...
define('PVWATTS_API_KEY', '9CbePe73oxetCcJujBhgfGH8f9TMUO3HQVGb2Qog'); // Get from https://developer.nrel.gov/signup/
define('PVWATTS_API_URL', 'https://developer.nrel.gov/api/pvwatts/v8.json');
define('OPENMETEO_API_URL', 'https://archive-api.open-meteo.com/v1/archive');
